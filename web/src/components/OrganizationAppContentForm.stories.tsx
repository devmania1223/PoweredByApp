...
import { OrganizationAppContentForm, OrganizationAppContentFormProps } from './OrganizationAppContentForm';
...
const mockContext = {
  identity: {
    ...
    firstName: 'Chester',
    lastName: 'Tester',
    organizationId: '123456abcdef',
    email: 'chestertester@sharklasers.com',
    username: 'abcd',
  },
};
export default {
  component: OrganizationAppContentForm,
  title: 'OrganizationAppContentForm',
  excludeStories: [],
  argTypes: {
    onSubmit: {
...
const defaultProps: OrganizationAppContentFormProps = {
  onSuccess: () => {},
  onCancel: () => {},
};
const Template = (args: OrganizationAppContentFormProps) => <OrganizationAppContentForm {...args} />;

export const WithoutSkip = () => Template(defaultProps);

export const WithDefaultSkipLink = () =>
  Template({
    ...defaultProps,
    onSkip: action('Form Skipped'), // Returns a handler function that logs in the Storybook 'Actions' panel
  });

export const WithCustomSkipLink = () =>
  Template({
    ...defaultProps,
    onSkip: action('Form Skipped'), // Returns a handler function that logs in the Storybook 'Actions' panel
    skipButtonLabel: <Typography color="primary">Skip this form...</Typography>,
  });
