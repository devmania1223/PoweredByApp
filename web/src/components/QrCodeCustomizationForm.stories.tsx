...
import { AppContext, Identity } from '../context/AppContext';
import { QrCodeCustomizationForm, QrCodeCustomizationFormProps } from './QrCodeCustomizationForm';
...
const mockContext: { identity: Identity } = {
  identity: {
    id: '123',
    firstName: 'Chester',
    lastName: 'Tester',
...
export default {
  component: QrCodeCustomizationForm,
  title: 'QrCodeCustomizationForm',
  excludeStories: [],
  argTypes: {
    onSuccess: {
...
const Template = (args: QrCodeCustomizationFormProps) => <QrCodeCustomizationForm {...args} />;

// @ts-ignore Default args are injected by Storybook from the 'argTypes' above
export const WithoutSkip = () => Template({});
